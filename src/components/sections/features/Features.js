...
const Features = ({ type }) => {
	...
	const features = [
		...
		{
			title: "Expert advice",
			desc: "Seasoned GRC specialists guide your strategy with proven frameworks and pragmatic insight.",
			icon: (
				<svg
					width="80"
					height="81"
		...
		},
		{
			...
			desc: "We turn objectives into roadmaps: prioritized, actionable, and aligned with your targets.",
			icon: (
				<svg
					width="80"
					height="81"
		...
		},
		{
			...
			desc: "We streamline processes to cut risk, boost compliance, and unlock continuous improvement.",
			icon: (
				<svg
					width="80"
					height="81"
							...
							<div className="col-12">
								<div className="sec-heading text-center">
									...
									<div className="desc wow fadeInUp" data-wow-delay="0.3s">
										<p>
											Our mission is to empower businesses of solutions
										</p>
									</div>
								</div>
							</div>
