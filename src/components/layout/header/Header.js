...
// import ButtonSearch from "@/components/shared/buttons/ButtonSearch"; // ← search disabled
          ...
          <div className="row">
            <div className="col-12">
              <div className="header-wrapper">
                ...
                {/* <!-- main navigation --> */}
                <Navbar isStickyHeader={isStickyHeader} headerType={headerType} />
                ...
                >
                  ...
                  */}
                  ...
                  {headerType !== 2 ? (
                    <ButtonPrimary
                      text={headerType === 8 ? "Free consultation" : "Get a quote"}
                      url={"/contact"}
                      className={
                        (headerType === 3 ||
                          headerType == 4 ||
